...
class UploadDefaults:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "notify_subscribers": str(self.notify_subscribers or "no").strip() or "no",
    ...
    def from_dict(cls, data: dict[str, Any] | None) -> "UploadDefaults":
        ...
        return cls(
            ...
            notify_subscribers=str(payload.get("notify_subscribers") or "no").strip() or "no",
